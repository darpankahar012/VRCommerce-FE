...
class Orders extends React.Component {
  ...
  componentDidMount = async () => {
    ...
    // }
    // const response = await instance.post(requests.fetchOrdersForAdmin,filterData,{
    //   headers:{
  ...
  applyFilter = async () => {
    ...
    const response = await instance
      .post(requests.fetchOrdersForAdmin, filterData, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      })
                            ...
                            <div className="avatar-group">
                              ...
                              >
                                <img
                                  alt="..."
                                  className="avatar avatar-sm"
                                  src={item.restaurant_Name.hasOwnProperty("restaurant_image") ? item.restaurant_Name.restaurant_image.image_url : process.env.REACT_APP_DEFAULT_IMAGE }
